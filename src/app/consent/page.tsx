...
DATA PRIVACY & ABSOLUTE ZERO DATA RETENTION SAFEGUARDS:
...
2. EPHEMERAL PROCESSING: Session data is processed entirely in temporary RAM and is permanently flushed immediately upon note generation.
3. LOCAL TRANSLATION: Audio is translated local-first via the browser. Raw audio recordings never leave the therapist's local device.
4. AUTO-WIPE MEMORY: For maximum local device security, copied text is completely auto-purged from the computer's clipboard after 60 seconds.
    ...
    <div className={styles.container} style={{ maxWidth: '1000px' }}>
      <header style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <div style={{ fontFamily: 'Inter, sans-serif', color: 'var(--primary)', marginBottom: '1rem' }}>
          <span style={{ display: 'block', fontSize: '1.8rem', fontWeight: 700, letterSpacing: '0.15em' }}>HIP HEALTH</span>
