...
import { ShieldCheck, ShieldAlert, Loader2, Lock, Mail, Smartphone, Laptop, AlertTriangle } from 'lucide-react';
  ...
  const handleVerifySMS = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // SMS MFA successful, redirect to consent page
        router.push('/consent');
      } else {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.card} style={{ maxWidth: '540px' }}>
        ...
        {/* Global Clinician Identity Verification Email Dispatched Notification */}
        <div style={{
          ...
          <div>
            <strong>Identity Verification Email Sent:</strong> A secure clinician verification link has been auto-dispatched to your registered account. Please check your inbox and verify to complete production scribing setup.
          </div>
        </div>
        ...
        <div className={styles.warningBox}>
          ...
          <span>
            <strong>Zero-Trust Architecture:</strong> Hip Health Scribe enforces automatic 3-minute screen blurs and 5-minute idle timeouts to guarantee medical record privacy.
          </span>
        </div>
      </div>
    </div>
