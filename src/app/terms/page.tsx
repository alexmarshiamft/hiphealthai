        ...
        <div style={{ lineHeight: '1.8', fontSize: '1.05rem', color: 'var(--text-main)' }}>
          ...
          <div style={{ padding: '1.5rem', backgroundColor: 'rgba(239, 68, 68, 0.05)', border: '1px solid rgba(239, 68, 68, 0.2)', borderRadius: '12px', marginBottom: '3rem' }}>
            ...
            <p style={{ fontSize: '0.95rem' }}>
              Hip Health is an AI-assisted documentation tool, not a medical device or a substitute for professional clinical judgment. By using this service, you acknowledge that you are a licensed healthcare professional and retain ultimate legal and ethical responsibility for all documentation generated and submitted to your Electronic Health Record (EHR) system.
            </p>
          </div>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              By accessing or using the Hip Health secure AI scribe (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you are using the Service on behalf of an organization, you are agreeing to these Terms for that organization and representing that you have the authority to bind that organization to these terms.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              The Service is designed to process Protected Health Information (PHI) in compliance with HIPAA. However, your use of the Service requires the execution of a valid Business Associate Agreement (BAA) between your organization and Hip Health prior to the transmission of any PHI.
            </p>
            <p style={{ marginBottom: '1rem' }}>
